...
contract BrainPassTest is PRBTest, Cheats {
    ...
    function testDifferentPassMint() public {
        ...
        assertEq(BrainPass.tokenURI(firstId), "https://example.com/1.json");
        ...
        assertEq(BrainPass.tokenURI(newId), "https://example.com/2.json");
        ...
        assertEq(BrainPass.tokenURI(newIds), "https://example.com/3.json");
